        ...
        tabItems(tabItem(tabName = "input_files",
                         tabBox(width = "1000px",
                                ...
                                tabPanel("Clinical Patient Data",
                                         fluidRow(box(title = "Input Patient Data File", width = 3, status = "primary", solidHeader = TRUE, collapsible = TRUE,
                                                      ...
                                                      prettyToggle(inputId = "Tab1_Clin_Header_Yes_or_No", label_on = "Header", label_off = "Header", icon_on = icon("check"), icon_off = icon("remove"), value = T, outline = T, shape = c("curve"),  status_on = "primary"), # Input: Checkbox if file has header
                                ...
                                tabPanel("Clinical Sample Data",
                                         fluidRow(box(collapsible = T, title = "Input Sample Data File", width = 3, status = "primary", solidHeader = TRUE, 
                                                      ...
                                                      prettyToggle(inputId = "Tab1_Sample_Header_Yes_or_No", label_on = "Header", label_off = "Header", icon_on = icon("check"), icon_off = icon("remove"), value = T, outline = T, shape = c("curve"),  status_on = "primary"), # Input: Checkbox if file has header
                                ...
                                tabPanel("CNA Data",  
                                         fluidRow(box(title = "Input CNA File", status = "primary", width = 3, solidHeader = TRUE, collapsible = T,
                                                      ...
                                                      prettyToggle(inputId = "Tab1_CNA_Header_Yes_or_No", label_on = "Header", label_off = "Header", icon_on = icon("check"), icon_off = icon("remove"), value = T, outline = T, shape = c("curve"),  status_on = "primary"), # Input: Checkbox if file has header
                                ...
                                tabPanel("Mutation Data", 
                                         fluidRow(box(collapsible = T, title = "Input MAF File", width = 3, status = "primary", solidHeader = TRUE,
                                                      ...
                                                      prettyToggle(inputId = "Tab1_MAF_Header_Yes_or_No", label_on = "Header", label_off = "Header", icon_on = icon("check"), icon_off = icon("remove"), value = T, outline = T, shape = c("curve"),  status_on = "primary"), # Input: Checkbox if file has header
                 ...
                 tabItem(tabName = "CNACalc",
                         box(style = "height:550px", sidebar = boxSidebar(id = "Tab3_CNA_Calculation_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"), h4(strong("Options")),
                                                                          ...
                                                                          conditionalPanel(condition = "input.Tab3_CNA_of_Interest == 'CNA Score'", h5(strong("Options:")), prettyToggle(inputId = "Tab3_CNA_Remove_NAs_Yes_or_No", label_on = "Remove NAs", label_off = "Remove NAs", icon_on = icon("check"), icon_off = icon("remove")),
                                                                                           prettyToggle(inputId = "Tab3_Segment_CNA_Yes_or_No", label_on = "Segment Data", label_off = "Segment Data", icon_on = icon("check"), icon_off = icon("remove")),
                 ...
                 tabItem(tabName = "Data_Down",
                         box(style = "height:530px", sidebar = boxSidebar(id = "Tab3_CNA_Download_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"), h4(strong("Options")), 
                                                                          ...
                                                                          prettyToggle(inputId = "Tab3_Download_File_Quote", label_on = "Include Quotes", label_off = "Include Quotes", icon_on = icon("check"), icon_off = icon("remove")),
                                                                          prettyToggle(inputId = "Tab3_Download_File_Row_Names", label_on = "Include Row Names", label_off = "Include Row Names", icon_on = icon("check"), icon_off = icon("remove")),
                 ...
                 tabItem(tabName = "boxplot", box(title = "Boxplot", solidHeader = T, width = 12, height = "630px", status = "primary", collapsible = T, withSpinner(plotOutput("plot3", height = "570px")), 
                                                  sidebar = boxSidebar(width = 25, id = "Tab4_Boxplot_Sidebar", background = "#599740",  icon = shiny::icon("list-alt"),
                                                                       ...
                                                                       prettyToggle(inputId = "Tab4_Boxplot_by_Sample_Size", label_on = "Boxplot by Sample Size", label_off = "Boxplot by Sample Size", icon_on = icon("check"), icon_off = icon("remove")), 
                                                                       prettyToggle(inputId = "Tab4_Boxplot_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")), 
                 ...
                 tabItem(tabName = "scatterplot", box(title = ("Scatterplot"), collapsible = T, solidHeader = T, width = 12, height= "630px", status = "primary", withSpinner(plotOutput("Scatterplot1", height = "570px")), 
                                                      sidebar = boxSidebar(width = 25, id = "Tab4_Scatterplot_Sidebar", background = "#599740",  icon = shiny::icon("list-alt"),
                                                                           ...
                                                                           prettyToggle(inputId = "Tab4_Scatterplot_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")), 
                 ...
                 tabItem(tabName = "Explor", box(title = ("Barplot"), solidHeader = T, width = 12, height= "630px", status = "primary", collapsible = T, withSpinner(plotOutput("Association3", height = "570px")), 
                                                 sidebar = boxSidebar(width = 25, id = "Tab4_Barplot_Sidebar", background = "#599740",  icon = shiny::icon("list-alt"),
                                                                      ...
                                                                      prettyToggle(inputId = "Tab4_Barplot_Display_NAs", label_on = "Display NA Values (x)", label_off = "Display NA Values (x)", icon_on = icon("check"), icon_off = icon("remove")), 
                             ...
                             sidebar = boxSidebar(width = 25, id = "Tab4_Density_Histogram_Sidebar", background = "#599740",  icon = shiny::icon("list-alt"),
                                                  ...
                                                  conditionalPanel(condition = "input.Tab4_Select_Plot_Type == 'Histogram'", h5(strong("Options:")), 
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Histogram_Type == 'Plain'", tags$hr(), 
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Histogram_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")),
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Histogram_Type == 'Facet Wrap'",
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Faceted_Histogram_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")), 
                                                  ...
                                                  conditionalPanel(condition = "input.Tab4_Select_Plot_Type == 'Density Plot'", h5(strong("Options:")),
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Density_Plot_Type == 'Plain'", tags$hr(),
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Density_Plot_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")),
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Density_Plot_Type == 'Segmented'",
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Segmented_Density_Plot_Display_Legend", label_on = "Display Legend", label_off = "Display Legend", icon_on = icon("check"), icon_off = icon("remove")), tags$hr(), 
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Density_Plot_Type == 'Facet Wrap'",
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Faceted_Density_Plot_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")),
                                                  ...
                                                  conditionalPanel(condition = "input.Tab4_Select_Plot_Type == 'Both'", h5(strong("Options:")),
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Both_Plot_Type == 'Plain'", tags$hr(),
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Both_Plot_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")),
                                                                   ...
                                                                   conditionalPanel(condition = "input.Tab4_Select_Both_Plot_Type == 'Facet Wrap'",
                                                                                    ...
                                                                                    prettyToggle(inputId = "Tab4_Faceted_Both_Plot_Display_NAs", label_on = "Display NA Values", label_off = "Display NA Values", icon_on = icon("check"), icon_off = icon("remove")),
                 ...
                 tabItem(tabName = "KMplot",
                         box(title = ("Kaplan-Meier Plot for Clinical Variables"), collapsible = T, solidHeader=T, width = 12, style = "height:520px; overflow-y: hidden", height = "520px", status = "primary", withSpinner(plotOutput("KM1", height="500px")), 
                             sidebar = boxSidebar(width = 25, id = "Tab5_KM_Clinical_Sidebar",  background = "#599740",  icon = shiny::icon("list-alt"), selectizeInput("Tab5_KM_Clinical_Survival_Time", "Survival Time:", choices = ""), selectizeInput("Tab5_KM_Clinical_Event_Status", "Event Status:", choices = ""), 
                                                  ...
                                                  prettyToggle(inputId = "Tab5_KM_Clinical_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),
                                                  prettyToggle(inputId = "Tab5_KM_Clinical_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")),
                                                  prettyToggle(inputId = "Tab5_KM_Clinical_Display_Pval", label_on = "Display P-value", label_off = "Display P-value", icon_on = icon("check"), icon_off = icon("remove")), 
                 ...
                 tabItem(tabName = "KMOver",
                         box(title = ("Kaplan-Meier Plot for CNA Scores and Quartiles"), width = 12, status = "primary", solidHeader = T,  style = "height:520px; overflow-y: hidden", height = "520px", collapsible = T, withSpinner(plotOutput("PercentSurv", height = "500px")),  
                             sidebar = boxSidebar(width = 25, id = "Tab5_KM_CNA_Quartile_Sidebar",  background = "#599740",  icon = shiny::icon("list-alt"), selectizeInput("Tab5_KM_CNA_Survival_Time", "Survival Time Column:", choices = ""), selectizeInput("Tab5_KM_CNA_Event_Status", "Event Status Column:", choices = ""), selectizeInput("Tab5_KM_CNA_Select_Variable", "Select Variable:", choices = ""), tags$hr(), # Variables of Interest
                                                  prettyToggle(inputId = "Tab5_KM_CNA_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),
                                                  prettyToggle(inputId = "Tab5_KM_CNA_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")), 
                                                  prettyToggle(inputId = "Tab5_KM_CNA_Display_Pval", label_on = "Display P-value", label_off = "Display P-value", icon_on = icon("check"), icon_off = icon("remove")), 
                 ...
                 tabItem(tabName = "KMplotRadio", 
                         box(title = ("Kaplan-Meier Plot for Treatment - Yes"), style = "height:500px", height = "500px", solidHeader=T, width = 12, collapsible = T, status = "primary", withSpinner(plotOutput("KMR1", height = "465px")),
                             ...
                             sidebar = boxSidebar(width = 25, id = "Tab5_KM_Treatment_Sidebar_Yes",  background = "#599740",  icon = shiny::icon("list-alt"), selectizeInput("Tab5_KM_Treatment_Survival_Time", "Survival Time:", choices = ""), selectizeInput("Tab5_KM_Treatment_Event_Status", "Event Status:", choices = ""),
                                                  ...
                                                  prettyToggle(inputId = "Tab5_KM_Treatment_Yes_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),  
                                                  prettyToggle(inputId = "Tab5_KM_Treatment_Yes_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")),
                                                  prettyToggle(inputId = "Tab5_KM_Treatment_Yes_Display_Pval", label_on = "Display P-value", label_off = "Display P-value", icon_on = icon("check"), icon_off = icon("remove")),
                         ...
                         box(title = ("Kaplan-Meier Plot for Treatment - No"), style = "height:500px", height = "500px", solidHeader=T, width = 12, collapsible = T, status = "primary", withSpinner(plotOutput("KMR2", height = "465px")), 
                             sidebar = boxSidebar(width = 25, id = "Tab5_KM_Treatment_Sidebar_No",  background = "#599740",  icon = shiny::icon("list-alt"), 
                                                  prettyToggle(inputId = "Tab5_KM_Treatment_No_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),  
                                                  prettyToggle(inputId = "Tab5_KM_Treatment_No_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")),
                                                  prettyToggle(inputId = "Tab5_KM_Treatment_No_Display_Pval", label_on = "Display P-value", label_off = "Display P-value", icon_on = icon("check"), icon_off = icon("remove")),
                 ...
                 tabItem(tabName = "AssumptionsOS", 
                         fluidRow(box(title = ("Multivariable Cox PH Model Assumptions"), collapsible = T, solidHeader = T, width = 12, status = "primary",  
                                      sidebar = boxSidebar(id="Tab7_Cox_Assumptions_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"), 
                                                           h5(strong("Options:")), prettyToggle(inputId = "Tab7_Cox_Assumptions_Display_by_Variable", label_on = "Display by Variable", label_off = "Display by Variable", icon_on = icon("check"), icon_off = icon("remove")),
                         ...
                         fluidRow(
                             ...
                             box(title = ("Adjusted Survival Curves"), collapsible = T, width = 12, solidHeader = T, status = "primary", 
                                 sidebar = boxSidebar(id="Tab8_Adjusted_Survival_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"), h5(strong("Options:")),
                                                      prettyToggle(inputId = "Tab8_Adjusted_Curves_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),  
                                                      prettyToggle(inputId = "Tab8_Adjusted_Curves_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")),
                             ...
                             box(title = ("Download Adjusted Survival Curves"), collapsible = T, width = 12, solidHeader = T, status = "primary", withSpinner(plotOutput("Pred3")), height = "430px", style = "height:430px",
                                 sidebar = boxSidebar(id="Tab8_Download_Adjusted_Survival_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"), selectInput("Tab8_Download_Adjusted_Curves_Select", "Select Plot:", choices = "", width = "95%"), 
                                                      h5(strong("Options:")),
                                                      prettyToggle(inputId = "Tab8_Download_Adjusted_Curves_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),  
                                                      prettyToggle(inputId = "Tab8_Download_Adjusted_Curves_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")),
                 ...
                 tabItem(tabName = "RpartTree",
                         fluidRow(box(collapsible = T, width = 12, status = "primary", height = "600px", title = "Rpart Survival Tree", solidHeader = TRUE, withSpinner(plotOutput("RpartTreePlot", height = "540px")), 
                                      ...
                                      sidebar = boxSidebar(id = "Tab9_Rpart_Tree_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"),
                                                           ...
                                                           prettyToggle(inputId = "Tab9_Rpart_Use_Complete_Cases_Only", label_on = "Complete Cases Only", label_off = "Complete Cases Only", icon_on = icon("check"), icon_off = icon("remove")),
                                  ...
                                  box(collapsible = T, height = "550px", width = 12, status = "primary", title = "Corresponding Survival Curves", solidHeader = TRUE, withSpinner(plotOutput("Surv_Curve1", height = "510px")),
                                      sidebar = boxSidebar(id="Tab9_Rpart_Surv_Sidebar", width =25, background = "#599740",  icon = shiny::icon("list-alt"), 
                                                           h5(strong("Options:")),
                                                           prettyToggle(inputId = "Tab9_Surv_Rpart_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),
                                                           prettyToggle(inputId = "Tab9_Surv_Rpart_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")), 
                                                           prettyToggle(inputId = "Tab9_Surv_Rpart_Display_Pval", label_on = "Display P-value", label_off = "Display P-value", icon_on = icon("check"), icon_off = icon("remove")), tags$hr(),
                 ...
                 tabItem(tabName = "STreeCtree",
                         fluidRow(box(collapsible = T, width = 12, status = "primary", height = "600px", title = "Ctree Survival Tree", solidHeader = TRUE, withSpinner(plotOutput("CTreePlot", height = "540px")), 
                                      ...
                                      sidebar = boxSidebar(id = "Tab9_Ctree_Tree_Sidebar", width = 25, background = "#599740",  icon = shiny::icon("list-alt"), selectizeInput("Tab9_Ctree_Survival_Time", "Survival Time:", choices =  ""), selectizeInput("Tab9_Ctree_Event_Status", "Event Status:", choices = ""), 
                                                           ...
                                                           prettyToggle(inputId = "Tab9_Ctree_Use_Complete_Cases_Only", label_on = "Complete Cases Only", label_off = "Complete Cases Only", icon_on = icon("check"), icon_off = icon("remove")),
                                                           ...
                                                           prettyToggle(inputId = "Tab9_Ctree_Stump", label_on = "Stump", label_off = "Stump", icon_on = icon("check"), icon_off = icon("remove")), 
                                  ...
                                  box(collapsible = T, width = 12, height = "550px", status = "primary", title = "Corresponding Survival Curves", solidHeader = TRUE, withSpinner(plotOutput("Surv_CurveCtree", height = "510px")), 
                                      sidebar = boxSidebar(id="Tab9_Ctree_Curv_Sidebar", width =25, background = "#599740",  icon = shiny::icon("list-alt"), h5(strong("Options:")),
                                                           prettyToggle(inputId = "Tab9_Surv_Ctree_Display_CI", label_on = "Display CI", label_off = "Display CI", icon_on = icon("check"), icon_off = icon("remove")),
                                                           prettyToggle(inputId = "Tab9_Surv_Ctree_Display_Risk_Table", label_on = "Display Risk Table", label_off = "Display Risk Table", icon_on = icon("check"), icon_off = icon("remove")), 
                                                           prettyToggle(inputId = "Tab9_Surv_Ctree_Display_Pval", label_on = "Display P-value", label_off = "Display P-value", icon_on = icon("check"), icon_off = icon("remove")), tags$hr(), 
                 ...
                 tabItem(tabName = "MAFVis", fluidRow(tabBox(width = 12, height = "1900px", # MAF summaries (Visual Plots)
                                                             tabPanel("MafSummary", box(collapsible = T, title=("MafSummary Plots"), height = "800px", width = 12, solidHeader = T, status = "primary", 
                                                                                        sidebar = boxSidebar(id="Tab10_MAF_Summary_Sidebar", width = 25,  background = "#599740",  icon = shiny::icon("list-alt"), h5(strong("Options:")), 
                                                                                                             prettyToggle(inputId = "Tab10_Summary_Remove_Outlier", label_on = "Remove Outliers", label_off = "Remove Outliers", icon_on = icon("check"), icon_off = icon("remove")), 
                                                                                                             prettyToggle(inputId = "Tab10_Summary_Dashboard_Style", label_on = "Dashboard Style", label_off = "Dashboard Style", icon_on = icon("check"), icon_off = icon("remove"), value=T),
                                                                                                             prettyToggle(inputId = "Tab10_Summary_Plot_Fraction", label_on = "Plot Fraction", label_off = "Plot Fraction", icon_on = icon("check"), icon_off = icon("remove")), 
                                                             ...
                                                             tabPanel("OncoPlot/OncoStrip", box(collapsible = T, title = "OncoPlot", width = 12, solidHeader = T, status = "primary", style = "height:530px", height = "530px",
                                                                      ...
                                                                      box(collapsible = T, title = "Transition and Transversions", width = 12, solidHeader = T, status = "primary", style = "height:530px", height = "530px",
                                                                          sidebar = boxSidebar(id="Tab10_TT_Sidebar", width = 25,  background = "#599740",  icon = shiny::icon("list-alt"), h5(strong("Options:")),
                                                                                               prettyToggle(inputId = "Tab10_TT_Plot_Fraction", label_on = "Plot Fraction", label_off = "Plot Fraction", icon_on = icon("check"), icon_off = icon("remove")), 
                                                                                               prettyToggle(inputId = "Tab10_TT_Include_Synonymous_Variants", label_on = "Include Synonymous Variants", label_off = "Include Synonymous Variants", icon_on = icon("check"), icon_off = icon("remove")), 
                                                             ...
                                                             tabPanel("Lollipop Plots", fluidRow(box(collapsible = T, title = ("Choose Genes to Analyse"), width = 12, status = "primary",  solidHeader = TRUE,
                                                                                                 ...
                                                                                                 box(collapsible = T, title = "Lollipop Plot 1", width = 12, solidHeader = T, status = "primary", height = "480px", withSpinner(plotOutput("lol1", height = "480px")), 
                                                                                                     sidebar = boxSidebar(id="Tab10_Lollipop_Plot1_Sidebar", width = 25, background = "#599740", icon = shiny::icon("list-alt"), 
                                                                                                                          ...
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Show_Mutation_Rate_1", label_on = "Show Somatic Mutation Rate", label_off = "Show Somatic Mutation Rate", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Label_Domains_1", label_on = "Label Domains", label_off = "Label Domains", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                                          sliderInput("Tab10_Lollipop_Label_Domains_Size_1", "Domain Label Size:", value = 0.8, min=0, max=2, step=0.1), tags$hr(),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Repel_Yes_or_No_1", label_on = "Repel", label_off = "Repel", icon_on = icon("check"), icon_off = icon("remove"), value = F),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Show_Legend_1", label_on = "Show Legend", label_off = "Show Legend", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                 ...
                                                                                                 box(collapsible = T, title = "Lollipop Plot 2", width  = 12, solidHeader = T, status = "primary", height = "480px", withSpinner(plotOutput("lol2", height = "480px")), 
                                                                                                     sidebar = boxSidebar(id="Tab10_Lollipop_Plot2_Sidebar", width = 25, background = "#599740", icon = shiny::icon("list-alt"), 
                                                                                                                          ...
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Show_Mutation_Rate_2", label_on = "Show Somatic Mutation Rate", label_off = "Show Somatic Mutation Rate", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Label_Domains_2", label_on = "Label Domains", label_off = "Label Domains", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                                          sliderInput("Tab10_Lollipop_Label_Domains_Size_2", "Domain Label Size:", value = 0.8, min=0, max=2, step=0.1), tags$hr(),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Repel_Yes_or_No_2", label_on = "Repel", label_off = "Repel", icon_on = icon("check"), icon_off = icon("remove"), value = F),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Show_Legend_2", label_on = "Show Legend", label_off = "Show Legend", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                 ...
                                                                                                 box(collapsible = T, title = "Lollipop Plot 3", width = 12, solidHeader = T, status = "primary", withSpinner(plotOutput("lol3", height = "480px")), height="480px", 
                                                                                                     sidebar = boxSidebar(id="Tab10_Lollipop_Plot3_Sidebar", width = 25, background = "#599740", icon = shiny::icon("list-alt"), 
                                                                                                                          ...
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Show_Mutation_Rate_3", label_on = "Show Somatic Mutation Rate", label_off = "Show Somatic Mutation Rate", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Label_Domains_3", label_on = "Label Domains", label_off = "Label Domains", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                                                                                          sliderInput("Tab10_Lollipop_Label_Domains_Size_3", "Domain Label Size:", value = 0.8, min=0, max=2, step=0.1), tags$hr(),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Repel_Yes_or_No_3", label_on = "Repel", label_off = "Repel", icon_on = icon("check"), icon_off = icon("remove"), value = F),
                                                                                                                          prettyToggle(inputId = "Tab10_Lollipop_Show_Legend_3", label_on = "Show Legend", label_off = "Show Legend", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                 ...
                 tabItem(tabName = "downlog",
                         fluidRow(box(collapsible = T, title = "Preview of Input Logs" , width = 12, status = "primary", solidHeader = TRUE, height = "500px",
                                      ...
                                      sidebar = boxSidebar(id="Tab11_Log_Options", width = 25, background = "#599740", icon = shiny::icon("list-alt"), 
                                                           ...
                                                           prettyToggle(inputId = "Tab11_Remove_None_Log", label_on = "Remove NULL/None Selected", label_off = "Remove NULL/None Selected", icon_on = icon("check"), icon_off = icon("remove"), value = T),
                                                           ...
                                                           prettyToggle(inputId = "Tab11_Download_Log_Quote", label_on = "Include Quotes", label_off = "Include Quotes", icon_on = icon("check"), icon_off = icon("remove")),
                                                           prettyToggle(inputId = "Tab11_Download_Log_Row_Names", label_on = "Include Row Names", label_off = "Include Row Names", icon_on = icon("check"), icon_off = icon("remove")), tags$hr(),
